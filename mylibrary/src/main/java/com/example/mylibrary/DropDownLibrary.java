...
public class DropDownLibrary<T> implements SearchAdapter.SetEmployeeName{
    ...
    public void main(Activity context, List<T> idName, String identifier, SetDataOnItemSelection setDataOnItemSelection) {
     ...
     * @param identifier
     */
    private void showList(Activity context, List<T> idName, String identifier) {
